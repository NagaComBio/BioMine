...
class vepconsequencevariant(mafvariant):
	def __init__(self , **kwargs):
		...
		self.cadd_phred = kwargs.get( 'cadd_phred', None )
		self.fathmm = kwargs.get( 'fathmm', None)
		self.gerp_rs = kwargs.get( 'gerp_rs', None)
		self.lrt = kwargs.get( 'lrt', None)
		self.m_assessor = kwargs.get( 'm_assessor', None)
		self.m_taster = kwargs.get( 'm_taster', None)
		...
		self.ada_score = kwargs.get('ada_score', None)
		self.rf_score = kwargs.get('rf_score', None)
